...
var fs = require('fs'), // library: file system
    dataForGraph = [],  // data displayed in chart
    chart;              // chart
...
function generarReporteVendedor() {
    var file = document.getElementById("archivo-vendedor");
    
    if (file !== null) {
        var contents = fs.readFileSync(file.files[0].path),
            data = [],
            topClientes = [],
            cliente     = "",
            comision    = 0,
